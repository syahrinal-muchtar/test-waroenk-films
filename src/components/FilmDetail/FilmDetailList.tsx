...
import { Wrapper, Label } from './FilmDetail.style';
...
export default function FilmDetailList({ label, list }: FilmDetailListProps) {
  return (
    <WrapperCustom>
      <Label>{label}</Label>
      {list?.length ? (
...
export type FilmDetailListProps = {
  label: string;
  list?: string[];
};

FilmDetailList.propTypes = {
